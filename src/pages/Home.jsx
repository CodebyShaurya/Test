...
import heroimg from '../assets/3D cartoonish image of a wizard with a huge beard playing with logos of a company, with the wizard in the middle.png'
      ...
      <section className="pt-20 md:pt-20">
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2 pt-20">
            <h1 className="text-4xl text-center lg:text-5xl xl:text-6xl font-bold leading-none">
                  Find Your Dream Job with <span className=' bg-gradient-to-r from-purple-800 to-indigo-800 bg-clip-text text-transparent'>RefWiz</span>
            </h1>
            <p className="text-xl lg:text-2xl mt-6 font-light text-center">
            We connect you with referrals from top companies, boosting your chances of landing your next opportunity!
            </p>
        ...
        text-white"
          ...
          <img src={heroimg} alt="Wizard with logos" className="w-full h-3/4" />
          </div>
        </div>
      </section>

            {/* <section className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-24 py-16 ">
            <div className="lg:w-1/2 mb-10 lg:mb-0">
              <h1 className="text-4xl font-bold"></h1>
              <p className="mt-4 text-lg">We connect you with referrals from top companies, boosting your chances of landing your next opportunity!</p>
            </div>
            <div className="lg:w-1/2">
        ...
        {/* <section className="py-16 px-6 lg:px-24 bg-gray-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="p-6 bg-white shadow-md rounded-lg">
              <h3 className="text-xl font-semibold">Personalized Referrals</h3>
              <p className="mt-2 text-gray-600">Get matched with companies and roles that suit your profile.</p>
            </div>
            <div className="p-6 bg-white shadow-md rounded-lg">
              <h3 className="text-xl font-semibold">Network Access</h3>
              <p className="mt-2 text-gray-600">Expand your network with our connections and industry experts.</p>
            </div>
            <div className="p-6 bg-white shadow-md rounded-lg">
              <h3 className="text-xl font-semibold">Trusted Support</h3>
              <p className="mt-2 text-gray-600">Our team is here to support you every step of the way.</p>
            </div>
          </div>
        </section> */}

<div class="font-[sans-serif] bg-gradient-to-r from-purple-800 to-indigo-800 py-12 ">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="mt-3 text-xl text-gray-500 sm:mt-4">
                Organic, genuine conversations with higher response rates than LinkedIn
                or cold email.
              </p>
            </div>
          </div>
    ...
    {/* Logo Carsuel */}
          ...
          <section className=" bg-gradient-to-r from-purple-800 to-indigo-800  text-white py-10 px-6 lg:px-24">
            <h2 className="text-3xl font-bold text-center mb-8">Companies we offer referrals in </h2>
            <div className="overflow-x-hidden">
              {/* <div className="flex justify-between space-x-6 animate-scroll"> */}
                {/* Replace with actual logos */}
                {/* <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" alt="Company 1" className="w-32 h-32 object-contain" />
                <img src="https://logos-world.net/wp-content/uploads/2020/04/Apple-Logo.png" alt="Company 2" className="w-32 h-32 object-contain" />
                <img src="https://cdn.pixabay.com/photo/2021/12/06/13/45/meta-6850393_960_720.png" alt="Company 3" className="w-32 h-32 object-contain" /> */}
                {/* Add more logos */}
              {/* </div> */}
            ...
            <div className="md:columns-2 lg:columns-3 gap-8 space-y-8">
              <div className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                ...
                <p className="mt-8">
                  ...
                  aspernatur laborum cum, a suscipit, ratione ea totam ullam! Lorem
    ...
    {/* Footer */}
              ...
              <footer className="bg-gradient-to-r from-purple-800 to-indigo-800  text-white py-6 px-6 lg:px-24">
                <div className="flex justify-between items-center">
                  <p>&copy; 2023 RefWiz. All rights reserved.</p>
